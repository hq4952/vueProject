        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="item in goodsInfo.spuSaleAttrList" :key="item.id">
                <dt class="title">{{item.saleAttrName}}</dt>
                <dd changepirce="0" :class="{active:value.isChecked === '1'}" v-for="(value,index) in item.spuSaleAttrValueList" 
                :key="value.id" @click="changeIschecked(index,item.spuSaleAttrValueList)">{{value.saleAttrValueName}}</dd>
